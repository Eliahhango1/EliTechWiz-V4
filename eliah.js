...
setInterval(async () => {
    if (conf.AUTO_BIO === "yes") {
        ...
        const bioText = `EliTechWiz-V4 is online!\n${currentDateTime}`; // Format the bio text
...
// Other functions (auto-react, anti-delete, etc.) as needed
  ...
  if (conf.ANTICALL === 'no') {
    ...
    await zk.sendMessage(callerId, {
      text: "Am EliTechWiz-V4,, My owner is unavailable try again later"
    });
  }
});
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ EliTechWiz-V4 is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ EliTechWiz-V4 Connected to WhatsApp! ☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("EliTechWiz-V4 is Online 🕸\n\n");
                //chargement des commandes 
                console.log("Loading EliTechWiz-V4 Commands ...\n");
